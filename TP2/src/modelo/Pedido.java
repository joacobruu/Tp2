...
public class Pedido {
  ...
  public String getProductos() {
    ...
    String lista = ""; //inicializo el String lista para poder ir concatenando el contenido de los distintos productos en el pedido a travez de un ForEach

    //Utilizo ForEach para poder recorrer el Array de productos
        for (Producto producto : productos) {
            i++; //Aumento en 1 el valor de la variable de control

            //Por cada producto en el Array, agrego al String lista el id, nombre y su precio utilizando el metodo toString de la clase Producto
  ...
  //Metodo para poder obtener el precio total del pedido (sumando el precio de cada producto en el)
  public int getTotal() {
